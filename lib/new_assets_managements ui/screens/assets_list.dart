                ...
                Expanded(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      if (filterAssignedTo.isNotEmpty && filterAssignedTo != 'All')
                        Positioned(
                          right: 36,
                ...
                Expanded(
                  ...
                  child: Stack(
                    ...
                    children: [
                      DropdownButtonFormField<String>(
                        isExpanded: true,
                        value: filterCategory.isEmpty || filterCategory == 'All'
                            ? null
                            : filterCategory,
                        decoration: InputDecoration(
                          contentPadding: const EdgeInsets.symmetric(
                ...
                Expanded(
                  ...
                  child: Stack(
                    ...
                    children: [
                      DropdownButtonFormField<String>(
                        isExpanded: true,
                        value: filterDepartment.isEmpty || filterDepartment == 'All'
                            ? null
                            : filterDepartment,
                        decoration: InputDecoration(
                          contentPadding: const EdgeInsets.symmetric(
                      ...
                      if (filterDepartment.isNotEmpty && filterDepartment != 'All')
                        Positioned(
                          right: 8,
                          child: GestureDetector(
                            onTap: () {
