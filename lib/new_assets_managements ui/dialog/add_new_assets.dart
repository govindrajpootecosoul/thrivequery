...
class AddNewAssetForm extends StatefulWidget {
  const AddNewAssetForm({Key? key}) : super(key: key);

  @override
  State<AddNewAssetForm> createState() => _AddNewAssetFormState();
}

class _AddNewAssetFormState extends State<AddNewAssetForm> {
  int currentStep = 1;
